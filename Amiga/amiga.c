...
*
* Copyright (C) 1997-2004  Niclas Karlsson
*
...
type32 dlimit, slimit;
  ...
  if (!gamename)
  {
    printf("Magnetic v2.2, an interpreter for Magnetic Scrolls games. Copyright © Niclas\n"
	   "Karlsson 1997-2004. Written by Niclas Karlsson, David Kinder, Stefan Meier\n"
...
char Version[] = "$VER:Magnetic 2.2 (8.4.2004)";
...
void amiga_about(void)
{
  amiga_req("Magnetic v2.2, an interpreter for Magnetic Scrolls games.\n"
	    "Copyright © 1997-2004 Niclas Karlsson.\n\n"
