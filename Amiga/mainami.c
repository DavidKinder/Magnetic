...
type32 dlimit, slimit;
  ...
  if (!gamename)
  {
    printf("Magnetic v2.0, an interpreter for Magnetic Scrolls games. Copyright © Niclas\n"
	   "Karlsson 1997-2000. Written by Niclas Karlsson, David Kinder, Stefan Meier\n"
	   "and Paul David Doherty.\n\n"
	   "Syntax: %s [options] game [gfxfile]\n\n"
...
char Version[] = "$VER:Magnetic 2.0 (21.10.2000)";
...
void amiga_about(void)
{
  amiga_req("Magnetic v2.0, an interpreter for Magnetic Scrolls games.\n"
	    "Copyright © 1997-2000 Niclas Karlsson.\n\n"
