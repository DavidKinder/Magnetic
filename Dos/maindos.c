...
*
*
* Magnetic v2.2, 16 bit DOS version, for Borland C 4.5.
*
* DOS interface for Magnetic Scrolls interpreter by Stefan Jokisch,
* updated for Magnetic 2.2 by David Kinder.
*
\***********************************************************************/
...
#define INFORMATION "\
Magnetic v2.2, an interpreter for Magnetic Scrolls games. Copyright (C) Niclas\n\
Karlsson 1997-2003. Written by Niclas Karlsson, David Kinder, Stefan Meier,\n\
...
static void hot_key_info (void) {
	...
	print_string ("\nMagnetic v2.2, an interpreter for Magnetic Scrolls games.\n");
	print_string ("Copyright (C) 1997-2003 Niclas Karlsson.\n\n");
	...
	print_string ("with changes for v2.2 by David Kinder.\n");
}/* hot_key_info */
...
int cdecl main (int argc, char **argv)
{
	...
	if (ms_init (story_name, (display >= _AMIGA_) ? gfx_name : NULL, hint_name) == 0)
