 ...
 * Updated for Magnetic 2.0 by David Kinder
 *
 */
...
#define INFORMATION "\
Magnetic v2.0, an interpreter for Magnetic Scrolls games. Copyright (C) Niclas\n\
...
static void hot_key_info (void) {
	...
	print_string ("with changes for v2.0 by David Kinder.\n");
}/* hot_key_info */
