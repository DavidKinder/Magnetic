...
void CMagneticApp::SetScaleFactor(double dFactor)
{
...
void CMagneticApp::SetScaleTitles(double dTitles)
{
	m_dScaleTitles = dTitles;
}

void CMagneticApp::SetForeColour(COLORREF Colour)
{
	m_ForeColour = Colour;
}

void CMagneticApp::SetBackColour(COLORREF Colour)
{
	m_BackColour = Colour;
}

void CMagneticApp::SetGfxColour(COLORREF Colour)
{
	m_GfxColour = Colour;
}
...
void CMagneticApp::SetAnimWait(BOOL bWait)
{
	m_bAnimWait = bWait;
}
...
void CMagneticApp::SetPredictable(BOOL bPredict)
{
	m_bPredict = bPredict;
}
...
void CMagneticApp::SetRandomSeed(int iSeed)
{
	m_iSeed = iSeed;
}
...
void CMagneticApp::SetGamma(double dGamma)
{
	m_dGamma = dGamma;
}
