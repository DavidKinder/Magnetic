...
BOOL CMagneticTitleDlg::OnInitDialog() 
{
	...
	int iWidth = (int)(m_BitmapInfo.biWidth * 2 * pApp->m_dScaleTitles);
	int iHeight = (int)(-1 * m_BitmapInfo.biHeight * pApp->m_dScaleTitles);
...
void CMagneticTitleDlg::OnPaint() 
{
	...
	dc.BitBlt(0,0,
						(int)(m_BitmapInfo.biWidth * 2 * pApp->m_dScaleTitles),
						(int)(-1 * m_BitmapInfo.biHeight * pApp->m_dScaleTitles),
						&dcMem,0,0,SRCCOPY);
	dcMem.SelectObject(pOldBitmap);
}

void CMagneticTitleDlg::OnPaletteChanged(CWnd* pFocusWnd)
{
	CDC* pDC = GetDC();
...
void CMagneticTitleDlg::ShowTitle(LPCTSTR pszGamePath)
{
    ...
    m_BitmapInfo.biClrUsed = 0;
		...
		m_BitmapInfo.biWidth = (int)(m_BitmapInfo.biWidth * 2 * pApp->m_dScaleTitles);
		m_BitmapInfo.biHeight = (int)(m_BitmapInfo.biHeight * pApp->m_dScaleTitles);
