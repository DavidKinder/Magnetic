...
void CMagneticView::SetMorePrompt(bool bMore)
{
	m_bMorePrompt = bMore;
}
...
BOOL CMagneticView::OpenGame(LPCTSTR lpszPathName)
{
	...
	// Initialize new game
	// [SM] ->
	//pApp->SetGameLoaded(ms_init((type8s*)lpszPathName,(type8s*)((LPCTSTR)strGfxName)));
	pApp->SetGameLoaded(ms_init((type8s*)lpszPathName,(type8s*)((LPCTSTR)strGfxName),(type8s*)((LPCTSTR)strHntName)));
	// <- [SM]
...
char CMagneticView::GetInput(bool& done)
{
