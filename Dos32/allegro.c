...
*
*
* Magnetic v2.2, 32 bit DOS Allegro version.
*
...
void process_args(int argc, char** argv)
{
  ...
  if (got_story == 0)
  {
    puts(
      ...
      "Copyright (C) Niclas Karlsson 1997-2003.\n"
...
void hotkey_info(void)
{
  ...
  screen_string("\nMagnetic v2.2, an interpreter for Magnetic Scrolls games.\n");
  screen_string("Copyright (C) 1997-2003 Niclas Karlsson.\n\n");
...
int main(int argc, char** argv)
{
  ...
  init_code = ms_init(story_name,gfx_name,hint_name);
  if (init_code == 0)
