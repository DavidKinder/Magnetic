...
* of list interface. The content array contains the actual description of
* the items. The nodetype is 1 if the items are "folders" and 2 if the items
* are hints. Hints should be displayed one after one. For "folder" items, the
* links array holds the index of the hint in the array which is to be displayed
* on selection. One hint block has exactly one type. The parent element 
